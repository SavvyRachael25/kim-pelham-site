        ...
        <section style={{ padding: '88px 24px', background: 'var(--color-cream)', borderTop: '1px solid var(--color-border)', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ maxWidth: 1180, margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: 56, alignItems: 'center' }} className="book-spread">
              <div style={{ position: 'relative', aspectRatio: '1451 / 2485', borderRadius: 4, overflow: 'hidden', boxShadow: '0 30px 60px rgba(26,26,26,0.18), 0 8px 18px rgba(26,26,26,0.12)', transform: 'rotate(-1.4deg)' }}>
                <Image src="/images/press/six-word-lessons-cover.jpg" alt="Six-Word Lessons on Selling Your Home in Seattle by Kim Pelham, book cover" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div>
