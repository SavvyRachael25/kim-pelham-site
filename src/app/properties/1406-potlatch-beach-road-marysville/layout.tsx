...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://thepelhamgroupnw.com/properties/1406-potlatch-beach-road-marysville',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://thepelhamgroupnw.com/properties/1406-potlatch-beach-road-marysville',
  },
};
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Properties', item: 'https://thepelhamgroupnw.com/properties' },
      {
        ...
        item: 'https://thepelhamgroupnw.com/properties/1406-potlatch-beach-road-marysville',
      },
    ],
  };

  // (Open House Event schema removed: the May 17 event has passed; listing remains active with showings by appointment.)
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. 1406 Potlatch Beach Road sits on 50 feet of high-bank Puget Sound waterfront in Marysville, Washington. Views include the Sound, nearby islands, the Olympic Mountains to the west, and Mt. Rainier to the south on clear days.',
        },
      },
      {
        '@type': 'Question',
