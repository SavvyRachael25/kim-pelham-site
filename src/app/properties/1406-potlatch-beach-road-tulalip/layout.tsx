...
export const metadata: Metadata = {
  ...
  description:
    '50 feet of high-bank Puget Sound waterfront. 3 bedrooms + 2 bonus rooms, 2 ensuite bathrooms, 1,662 sqft on 0.36 acres. $950,000. MLS# 2504310. Contact Kim Pelham (425) 250-9422.',
  openGraph: {
...
export default function PotlatchLayout({ children }: { children: React.ReactNode }) {
  ...
  const listingSchema = {
    ...
    description:
      '50 feet of high-bank Puget Sound waterfront. 3 bedrooms plus 2 bonus rooms, 2 ensuite bathrooms, 1,662 square feet on a 0.36-acre lot. Built 1925, meticulously maintained. Hot tub, gazebo, panoramic Sound, island, and Olympic Mountain views. $950,000. MLS# 2504310.',
    url: 'https://thepelhamgroupnw.com/properties/1406-potlatch-beach-road-tulalip',
    image: [
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '1406 Potlatch Beach Road is listed at $950,000. This waterfront home offers 1,662 square feet, 3 bedrooms plus 2 bonus rooms, 2 bathrooms, and 50 feet of high-bank Puget Sound frontage on 0.36 acres in Marysville, WA. MLS# 2504310.',
        },
      },
      {
        '@type': 'Question',
