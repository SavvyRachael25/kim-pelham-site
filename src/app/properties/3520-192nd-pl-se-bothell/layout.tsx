...
export const metadata: Metadata = {
  ...
  description:
    'For sale at $1,179,000. A 2016 home in the Village at Brookshire neighborhood of Bothell. 4 bed, 2.5 bath, 2,453 sqft, 13 rooms, on a 3,907 sqft lot. Soaring ceilings, open floor plan, quartz kitchen with walk-in pantry, upstairs loft, five-piece primary bath, covered patio, central A/C, pre-inspected and move-in ready. Northshore School District. NWMLS #2558328. Book a showing with Kim Pelham at (425) 250-9422.',
  openGraph: {
    title: 'For Sale · 3520 192nd Pl SE, Bothell WA | Move-In Ready in Village at Brookshire',
    description:
      'For sale at $1,179,000. 2016 build, 4 bed, 2.5 bath, 2,453 sqft. Soaring ceilings, open floor plan, quartz kitchen with walk-in pantry, upstairs loft, five-piece primary bath, covered patio, central A/C. Pre-inspected and move-in ready. Northshore School District. NWMLS #2558328.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'For Sale · 3520 192nd Pl SE, Bothell WA 98012 | The Pelham Group NW',
    description:
      'For sale at $1,179,000. 2016 build, 4 bed, 2.5 bath, 2,453 sqft in Village at Brookshire. Pre-inspected and move-in ready. Northshore School District. NWMLS #2558328.',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '3520 192nd Pl SE is listed at $1,179,000. It is a 4-bedroom, 2.5-bathroom, 2,453 sqft home built in 2016 in the Village at Brookshire neighborhood of Bothell, WA 98012. NWMLS #2558328.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '3520 192nd Pl SE was listed on July 23, 2026 and is active and for sale at $1,179,000. To book a private showing, text or call Kim Pelham at (425) 250-9422.',
        },
      },
      {
        '@type': 'Question',
