...
const stats = [
  { label: 'Median Home Price', value: '$662K to $715K', sub: '2025 range' },
  ...
  { label: 'Commute to Everett', value: '10 to 15 min', sub: 'via US-2' },
];
      ...
      <main>
        ...
        <section style={{ padding: '80px 20px', backgroundColor: '#FFFFFF' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '1.1rem', lineHeight: 1.8, color: '#2C2C2C' }}>
              The honest caveat: US-2 through the Trestle is a real bottleneck in rush hour. The 10-minute drive to Everett can become 25 to 35 minutes when it backs up. People who love Lake Stevens have made peace with this  -  or they commute off-peak.
            </p>
          </div>
        </section>
        ...
        <section style={{ padding: '80px 20px', backgroundColor: '#F8F5F0' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #E8E3DA', borderRadius: '6px', padding: '28px' }}>
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.875rem', fontWeight: 700, color: '#B8845C', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '16px' }}>Lake Stevens School District</div>
        ...
        <FAQSection
          ...
          faqs={[
            ...
            { question: 'What is the commute from Lake Stevens to Everett?', answer: '10 to 15 minutes on a normal day via US-2 East. However, the US-2 Trestle through Everett is a known bottleneck during rush hour  -  that 10-minute drive can stretch to 25 to 35 minutes on a bad morning. Most Lake Stevens residents plan their commute schedule around the Trestle timing or work with a hybrid schedule.' },
