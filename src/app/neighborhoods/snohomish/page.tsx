...
const insiderFacts = [
  { emoji: '🏺', title: 'Snohomish is literally the Antique Capital of the Northwest', body: 'First Street downtown has over 400 antique dealers — not exaggerated, not a marketing slogan. People drive from Oregon, BC, and Eastern Washington specifically to shop here. If you buy a house in Snohomish, you will develop opinions about antiques whether you intended to or not.' },
  { emoji: '🚣', title: 'You can kayak from your neighborhood on a Sunday morning', body: 'The Snohomish River runs right through town. Pilchuck Park has kayak and canoe launch access. The Snohomish Estuary and the surrounding sloughs are a birding and paddling destination. This is an actual lifestyle, not a brochure claim.' },
  { emoji: '🚴', title: 'The Centennial Trail ends (or starts) here — 30+ miles of paved trail', body: 'The Centennial Trail runs from Snohomish north to Arlington — 31.5 miles of paved, multi-use trail through Snohomish County. Cyclists, runners, inline skaters. If you live in Snohomish, you are steps from one of the great regional trails in the Pacific Northwest.' },
  { emoji: '🏡', title: 'Victorian homes from the 1880s are still standing — and livable', body: 'Snohomish was settled in the 1850s and is one of the oldest towns in Snohomish County. The historic district has lovingly maintained late-19th-century homes. If you want actual character instead of "craftsman-inspired" new builds, this is where you look.' },
  { emoji: '🌾', title: 'The drive home goes through actual farmland', body: 'Snohomish sits at the edge of the Snohomish River valley — and the valley is still actively farmed. U-pick farms, farm stands, Thomas Family Farm, Hopewell Farm. The Sunday drive for produce isn\'t even a drive; it\'s the commute home.' },
  { emoji: '🍺', title: 'The Oxford Saloon has been open since 1900 — and it\'s supposedly haunted', body: 'One of the oldest continually-operating bars in Washington state. The Oxford Saloon is a full bar and restaurant with a well-documented ghost history (Ghost Adventures has filmed here). It\'s the kind of place that makes a neighborhood feel like it has layers.' },
];
        ...
        <section style={{ padding: '80px 20px', backgroundColor: '#F8F5F0' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #E8E3DA', borderRadius: '6px', padding: '28px' }}>
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.85rem', fontWeight: 700, color: '#B8845C', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '16px' }}>Snohomish School District Highlights</div>
