...
const insiderFacts = [
  { emoji: '🏫', title: 'The school district is genuinely why people move here — and it\'s worth the price', body: 'Northshore School District is ranked #10 in all of Washington state. North Creek High School is top 25. If you have kids and you\'re choosing between Bothell and somewhere $200K cheaper, you are paying for the school district. Many buyers decide it\'s worth every dollar.' },
  { emoji: '🍷', title: 'Woodinville wine country is literally 10 minutes away', body: 'Over 100 wineries and tasting rooms — and you can get to most of them without getting on a highway. If you appreciate weekend wine culture without a three-hour round trip, this is not an accident that Bothell homeowners talk about constantly.' },
  { emoji: '🏘️', title: 'The county line runs through the middle of the city — and it matters', body: 'Bothell straddles King and Snohomish Counties. Zip code 98021 (Canyon Park area, northeast Bothell) is Snohomish County. Zip 98011 is King County. Both feed into the same Northshore School District, but the tax structure and some services differ. Know which side of the line you\'re buying on.' },
  { emoji: '🚶', title: 'The Sammamish River Trail is a 10-mile linear gem right through the city', body: 'It runs from Bothell Landing to Marymoor Park in Redmond — flat, paved, and heavily used. Cyclists, runners, families with strollers. It\'s the kind of amenity that sounds basic until you\'re using it on a Tuesday and realize you haven\'t driven anywhere all day.' },
  { emoji: '🏨', title: 'McMenamins Anderson School is a hotel inside a converted junior high', body: 'Yes, really. The old Anderson Junior High was converted into a boutique hotel with multiple restaurants, a soaking pool, movie theater, and art throughout. It\'s one of the most distinctive local venues in all of Snohomish County and it\'s in downtown Bothell.' },
  { emoji: '📈', title: 'Canyon Park (98021) is where the growth is happening', body: 'University of Washington Bothell campus, tech office parks, newer apartment buildings, and proximity to Redmond via Canyon Road — the northeast Bothell / Canyon Park area is the upside zip code. Established homeowners are here. New buyers are coming fast.' },
];
