      ...
      <main>
        ...
        <article style={{ padding: '72px 24px 80px', backgroundColor: '#FFFFFF' }}>
          <div style={{ maxWidth: '760px', margin: '0 auto' }}>
            ...
            >
              1406 Potlatch Beach Road in Tulalip is listed at $799,900. It is high-bank waterfront on Puget Sound. The views are sweeping. The sunsets are the kind that stop you mid-sentence. It is 35 miles north of Seattle on the same water.
            </p>
        ...
        <FAQSection
          ...
          faqs={[
            ...
            },
            {
              ...
              answer:
                'Property tax rates in Tulalip (ZIP 98271, Snohomish County) run approximately 0.9% to 1.1% of assessed value annually. On a $799,900 property, expect roughly $8,100 to $9,900 per year. Snohomish County property taxes are generally lower than King County rates for comparable assessed values. Verify current figures for any specific parcel with the Snohomish County Assessor at snohomishcountywa.gov.',
            },
          ]}
        />
