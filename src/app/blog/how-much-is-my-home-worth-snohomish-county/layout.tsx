...
export const metadata: Metadata = {
  ...
  description: 'A Zestimate is a starting point, not a price. How a Snohomish County broker of 14 years actually values a home: comps, adjustments, and what public estimates miss.',
  openGraph: {
