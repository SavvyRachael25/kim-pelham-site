      ...
      <main>
        ...
        <article style={{ padding: '80px 20px', backgroundColor: '#fff' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <TextMeAsk question="Would staging or a price cut move your house?" page="staging-beats-price-cuts" />
            ...
            <section style={{ marginTop: '80px', paddingTop: '40px', borderTop: '1px solid var(--color-border)' }}>
              ...
              <div style={{ marginBottom: '28px', paddingBottom: '28px', borderBottom: '1px solid var(--color-border)' }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', color: 'var(--color-text)', lineHeight: 1.75, margin: 0 }}>
                  A staging consultation runs $200 to $400. Hands-on staging implementation for an occupied home typically costs $500 to $2,000 depending on the size of the house, how much furniture needs to come in, and the logistics of the job. Kim stages homes herself and almost always charges for staging, keeping the cost low on purpose. Unlike a staging company, she does not charge a monthly furniture rental fee, which commonly runs $800 to $2,000 a month.
                </p>
              </div>
