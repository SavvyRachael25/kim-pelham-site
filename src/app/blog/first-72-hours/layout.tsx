...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://thepelhamgroupnw.com/blog/first-72-hours' },
};
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": { "@type": "Answer", "text": "In Snohomish County, well-priced homes in active markets like Mill Creek, Bothell, and Lake Stevens typically go under contract within 5 to 10 days. Homes that are priced correctly and professionally marketed often receive offers within the first 72 hours. Homes priced above market can sit for 30 to 60+ days and typically sell below list price." }
              },
              {
                "@type": "Question",
                "name": "What happens when you list a house on the MLS?",
                "acceptedAnswer": { "@type": "Answer", "text": "When a home is listed on the MLS, it syndicates within hours to Zillow, Redfin, Realtor.com, and hundreds of partner sites. Buyers with saved searches receive instant alerts. Buyer's agents review new inventory for their active clients. This creates a surge of attention in the first 24 to 72 hours that is the highest point of buyer interest during the entire listing period." }
              },
              {
                "@type": "Question",
