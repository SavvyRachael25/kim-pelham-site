      ...
      />
        ...
        <article style={{ padding: '80px 20px', backgroundColor: '#fff' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            >
              Hour 1 to 6: Preparation and Photography
            </h3>
            ...
            >
              Hour 6 to 24: Strategic Pricing & Digital Launch
            </h3>
            ...
            >
              Hour 24 to 48: Staging & Showings
            </h3>
            ...
            >
              By this point, your home should be staged, clean, and ready for an onslaught of showings. Staged homes sell 25 to 35% faster and at higher prices than unstaged homes. Every listing I take gets a staging consultation before we hit the market, this isn't optional, it's part of the strategy.
            </p>
            ...
            >
              Hour 48 to 72: Collecting Offers & Momentum
            </h3>
            ...
            <section style={{ marginTop: '80px', paddingTop: '40px', borderTop: '1px solid var(--color-border)' }}>
              ...
              <div style={{ marginBottom: '28px', paddingBottom: '28px', borderBottom: '1px solid var(--color-border)' }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', color: 'var(--color-text)', lineHeight: 1.75, margin: 0 }}>
                  As of early 2026, the median days on market in Snohomish County hovers around 18 to 25 days, but well-priced, well-presented homes routinely go under contract in under a week. The first 72 hours are when the most motivated buyers act.
                </p>
              </div>
              ...
              <div style={{ marginBottom: '28px', paddingBottom: '28px', borderBottom: '1px solid var(--color-border)' }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', color: 'var(--color-text)', lineHeight: 1.75, margin: 0 }}>
                  Buyers searching online see "Days on Market" and use it as a signal. A home that's been sitting for 2 to 3 weeks starts to feel like it has a problem, even if it doesn't. Serious buyers act fast, if they haven't seen your home in the first 72 hours, they've often already moved on.
                </p>
              </div>
              ...
              <div style={{ marginBottom: '28px', paddingBottom: '28px', borderBottom: '1px solid var(--color-border)' }}>
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', color: 'var(--color-text)', lineHeight: 1.75, margin: 0 }}>
                  Kim starts the pre-listing process 2 to 4 weeks before the listing goes live. This includes a detailed staging consultation, professional photography, pricing analysis, and coordinated marketing launch so the home hits Zillow, Redfin, and MLS simultaneously on day one with maximum visibility.
                </p>
              </div>
            </section>
