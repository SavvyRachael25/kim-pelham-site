...
export const metadata: Metadata = {
  ...
  description: "Kim Pelham has sold 50+ Everett homes over a 14-year real estate career. Here's the real story on Everett neighborhoods: which ones flood, which have the best schools, and where first-time buyers actually end up happy.",
  openGraph: {
