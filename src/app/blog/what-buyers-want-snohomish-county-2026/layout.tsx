...
export const metadata: Metadata = {
  ...
  description: 'Buyers in Mill Creek, Bothell and Lake Stevens are more selective and value-conscious than in 2021. What they actually want, from 14 years of reading buyer feedback.',
  openGraph: {
