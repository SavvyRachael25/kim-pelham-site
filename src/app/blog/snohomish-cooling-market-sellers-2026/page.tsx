        ...
        <article style={{ padding: '80px 20px', backgroundColor: '#fff' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <GuideGate
              ...
              blurb="What to do about a slower market: the 90-day timeline, the pricing chapter, staging, and what a sale actually costs. Eight pages, designed to print."
