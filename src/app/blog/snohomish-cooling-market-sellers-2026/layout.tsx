...
export const metadata: Metadata = {
  ...
  description: "Snohomish County in 2026 is cooler than 2021, but it is not a buyer's market and not a crash. What rising inventory actually means for sellers, from 14 years of cycles.",
  openGraph: {
