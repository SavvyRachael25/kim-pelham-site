        ...
        <article style={{ padding: '72px 20px 96px', backgroundColor: '#fff' }}>
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            ...
            <p style={{ ...styles.bodyP, fontWeight: 600, color: 'var(--color-forest)' }}>
              ...
              Stephanie Galindo, an ADHD coach I have known for years, and she gave me the best answer I
              have ever heard.
            </p>
            ...
            <p style={styles.bodyP}>
              Community Spotlight is new, so here is the why. After 14 years of selling homes, I know
