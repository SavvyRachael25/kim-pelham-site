...
export const metadata: Metadata = {
  ...
  description: 'A $899,900 high-bank Puget Sound waterfront in Tulalip vs. a $975,000 view-first remodel in Mukilteo. How to think about the trade-offs at the sub-$1M price point in Snohomish County.',
  alternates: {
