    ...
    <>
      ...
      <main>
        <InnerHero
          ...
          imageAlt="Sunset over Puget Sound from Tulalip waterfront"
        />

        <article style={{ padding: '80px 20px', backgroundColor: '#fff' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <p style={{ ...bodyP, fontWeight: 700 }}>
              Two of my current listings sit just under the million-dollar mark in Snohomish County, and they answer the same question two completely different ways. One is a high-bank Puget Sound waterfront in Tulalip at $899,900. The other is a fully remodeled view-first home in Mukilteo at $975,000. If you&rsquo;re shopping in this price band, this is the trade-off that actually matters.
            </p>
            ...
            >
              ...
              <p style={{ ...bodyP, fontSize: '1rem', marginBottom: '8px' }}>
                <strong>1406 Potlatch Beach Road, Tulalip:</strong> $899,900 · 50&prime; high-bank waterfront on Puget Sound · 3 bed + 2 bonus rooms · 1,662 sqft · 0.36 acres · MLS# 2504310
              </p>
