...
export const metadata: Metadata = {
  ...
  description: "What is a sale-to-list ratio and why does Kim Pelham's 104.4% matter? Here's what this number tells you about who to trust with your Snohomish County home sale.",
  openGraph: {
  ...
  alternates: { canonical: 'https://kim-pelham-site.vercel.app/blog/sale-to-list-ratio' },
};
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": { "@type": "Answer", "text": "In Snohomish County, a sale-to-list ratio between 100–102% is considered strong, meaning the home sold at or slightly above asking price. A ratio above 102% is very strong and typically indicates multiple offers. A ratio of 104% or higher — like Kim Pelham's 104.4% average — is exceptional and reflects a consistent process of strategic pricing and competitive buyer demand generation." }
              },
              {
                "@type": "Question",
